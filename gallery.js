...
const mediaItems = [
    ...
    {src: "img_optimizada/aula_cuenca-min_resultado.webp", x: 1000, y: 7500, type: "image"},
    {src: "img_optimizada/IMG_20250609_043629-min_resultado.jpg", x: 4000, y: 8800, type: "image"},
    {src: "img_optimizada/PXL_20250226_171318569.RAW-01.COVER-min_resultado.jpg", x: 9000, y: 800, type: "image"},
    {src: "img_optimizada/PXL_20250830_185121345_resultado.webp", x: 7000, y: 800, type: "image"},
    {src: "img_optimizada/PXL_20250831_103101053_resultado.webp", x: 3000, y: 900, type: "image"},
    {src: "img_optimizada/PXL_20250831_103354825_resultado.webp", x: 900, y: 800, type: "image"},
    {src: "img_optimizada/PXL_20250831_115327149_resultado.webp", x: 900, y: 8000, type: "image"},
    {src: "img_optimizada/PXL_20250831_193407976_resultado.webp", x: 200, y: 7000, type: "image"},
    {src: "img_optimizada/PXL_20250903_222242520_resultado.webp", x: 100, y: 3000, type: "image"},
    {src: "img_optimizada/PXL_20250905_104807436.webp", x: 400, y: 7000, type: "image"},
    {src: "img_optimizada/PXL_20250903_222442335_resultado.webp", x: 600, y: 4000, type: "image"},
    {src: "img_optimizada/PXL_20250913_122707031_resultado.webp", x: 800, y: 2000, type: "image"},
    {src: "img_optimizada/PXL_20250909_211818029.webp", x: 2000, y: 15000, type: "image"},
    {src: "img_optimizada/plano proyeccion color plano_resultado.webp" , x: 200, y: 5200, type: "image"},
    {src: "img_optimizada/plano proyeccion color plano2_resultado.webp" , x: 50, y: 3600, type: "image"},
    {src: "img_optimizada/plano proyeccion web [Recuperado]-02_resultado.webp" , x: 150, y: 2200, type: "image"},
    {src: "img_optimizada/plano proyeccion web [Recuperado]-03_resultado.webp" , x: 50, y: 6720, type: "image"},
     ...
     {src: "https://dani-latre.xyz/media/6_am.mp4", x: 50, y: 7500, type: "video"},
     {src: "https://dani-latre.xyz/media/reflectante_opt.mp4", x: 50, y: 7500, type: "video"},
...
itemsToRender.forEach((item, index) => {
 ...
 let mediaElement;
    ...
    // === AQUÍ AÑADIMOS EL CONTROL DE ERRORES ===
    // Si la imagen o vídeo no existe en la carpeta, destruye todo su contenedor
    mediaElement.addEventListener('error', function() {
      container.remove(); 
      console.warn(`El archivo no se pudo cargar y fue removido: ${item.src}`);
    });
    // ===========================================
